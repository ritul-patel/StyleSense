...
exports.getRecommendationAsync = getRecommendationAsync;
// ─── Palette data ─────────────────────────────────────────────────────────────
const P = {
    // ── TYPE I COOL ──────────────────────────────────────────────────────────────
    "I_cool": {
...
function resolveKey(type, undertone) {
...
function undertoneNotes(undertone) {
    const u = undertone.toLowerCase();
    if (u === "warm")
        return "Warm undertones suit earthy, golden, and orange-adjacent colour families.";
    if (u === "cool")
        return "Cool undertones suit jewel tones, blue-based neutrals, and true whites.";
...
function getRecommendationAsync(profile) {
