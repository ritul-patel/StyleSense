...
| [database.md](database.md) | Database schema, migrations, query patterns |
| [auth.md](auth.md) | Authentication flow, JWT handling, Supabase Auth setup |
| [ai-pipeline.md](ai-pipeline.md) | Gemini integration, image pipeline, metadata generation |
| [deployment.md](deployment.md) | Deployment guide for Vercel (client) and Railway/Render (server) |
| [environment.md](environment.md) | All environment variables with descriptions |
