...
export default function SignupPage() {
  ...
  const handleTermsChange = (checked: boolean) => {
    ...
    setTermsError("");
    // Track only the first time user accepts (not repeated toggles)
          ...
          <div className="mt-5">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-y-4">
                ...
                {/* Password */}
                <div>
                  <label htmlFor="password" className="mb-2 block text-sm text-gray-800 dark:text-neutral-200">
                    Password
                  </label>
                  <input
                    type="password"
                ...
                {/* Confirm Password */}
                <div>
                  <label htmlFor="confirm-password" className="mb-2 block text-sm text-gray-800 dark:text-neutral-200">
                    Confirm Password
                  </label>
                  <input
                    type="password"
                ...
                <div>
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      className="mt-0.5 size-4 shrink-0 rounded-sm border-gray-300 bg-transparent text-blue-600 shadow-2xs focus:ring-2 focus:ring-blue-600/20 focus:ring-offset-0 checked:border-blue-600 checked:bg-blue-600 dark:border-neutral-600 dark:checked:border-blue-500 dark:checked:bg-blue-500"
                      aria-describedby="terms-error"
                    />
                    <label htmlFor="terms-checkbox" className="text-sm text-gray-600 dark:text-neutral-300 leading-snug">
                  ...
                  {termsError && (
                    <p id="terms-error" className="mt-2 text-xs text-red-600 dark:text-red-400">
                      {termsError}
                    </p>
                  )}
                </div>
                ...
                {/* Errors & Success */}
                {error && (
                  <p id="signup-error" className="text-xs text-red-600 dark:text-red-400">
                    {error}
                  </p>
                )}
